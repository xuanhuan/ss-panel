													...
													<ul class="nav nav-list margin-no pull-left">
														<li class="dropdown">
															...
															<ul class="dropdown-menu">
																<li><a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">location_on</i>&nbsp;伺服器地址：<{$row['node_server']}></a></li>
																<li><a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">device_hub</i>&nbsp;伺服器状态：<{$row['node_status']}></a></li>
																<li><a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">security</i>&nbsp;伺服器加密方式：<{$row['node_method']}></a></li>
															</ul>
														</li>
													</ul>
													<ul class="nav nav-list margin-no pull-left">
														<li><a href="javascript:void(0)" class='dropdown-toggle text-black waves-attach'><i class="icon icon-lg">import_export</i><span class="ping" id="<{$row['id']}>_ping" value="<{$row['node_server']}>">Ping</span></a></li>
													</ul>
